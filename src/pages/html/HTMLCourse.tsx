  ...
  return (
    <div className="min-h-screen pt-16 bg-gray-50 dark:bg-gray-900">
      <div className="container mx-auto px-4 py-8 flex gap-6">
        {/* Collapsible Sidebar */}
        <div 
          className={`transition-all duration-300 bg-white dark:bg-gray-800 rounded-xl shadow-lg sticky top-24 overflow-y-auto max-h-[calc(100vh-8rem)] ${
        ...
        {/* Main Content */}
        <div className="flex-1 bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 overflow-y-auto max-h-[calc(100vh-8rem)]">
